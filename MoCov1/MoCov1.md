...
就有监督学习来说，对于图像分类这个判断标准就是人的自然语言和图像匹配，让机器学会这种匹配关系；对于图像分割这个判断标准无非是精确到了像素级别，判断每个像素应该是属于什么类别，因此判断标准是人预先分割好的图像，是人根据自己的想法对于图像中的信息和图像的匹配
